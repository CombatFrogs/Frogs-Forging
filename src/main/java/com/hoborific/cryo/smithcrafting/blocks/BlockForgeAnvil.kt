package com.hoborific.cryo.smithcrafting.blocks
...
class BlockForgeAnvil : Block(Material.IRON), ITileEntityProvider {
    init {
        unlocalizedName = SmithcraftingMod.MODID + ".forge_anvil"
    ...
    override fun onBlockActivated(
        ...
        player!!.openGui(SmithcraftingMod.instance!!, GUI_ID, world, pos.x, pos.y, pos.z)
